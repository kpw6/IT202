...
if (isset($id)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT turtle.id,name,state,base_rate,mod_min,mod_max,next_stage_time, user_id, Users.username FROM Turtles as turtle JOIN Users on turtle.user_id = Users.id where turtle.id = :id");
